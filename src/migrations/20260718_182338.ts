...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_case_studies_industry" AS ENUM('E-commerce', 'Professional Services', 'SaaS');
  ...
  CREATE TABLE "posts" (
  	...
  	"body" jsonb,
  	"author" varchar DEFAULT 'LaunchNest',
  ...
  CREATE TABLE "case_studies_what_we_did" (
  ...
  CREATE TABLE "case_studies" (
  	...
  	"slug" varchar NOT NULL,
  	"industry" "enum_case_studies_industry" NOT NULL,
  	"headline_result" varchar NOT NULL,
  	"summary" varchar NOT NULL,
  	"cover_image_id" integer,
  	"accent" varchar DEFAULT '#0B1F3A',
  ...
  ALTER TABLE "case_studies_what_we_did" ADD CONSTRAINT "case_studies_what_we_did_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."case_studies"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "case_studies_what_we_did_order_idx" ON "case_studies_what_we_did" USING btree ("_order");
  CREATE INDEX "case_studies_what_we_did_parent_id_idx" ON "case_studies_what_we_did" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "case_studies_what_we_did" CASCADE;
